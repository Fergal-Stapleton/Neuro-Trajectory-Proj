...
class GeneticAlgorithm:
    ...
    def generate_moead(self):
        ...
        genomes = evolver.create_population(self.population, self.decomp)
        extArchivePop = []
        ...
        genome_inc = 0
        for genome in genomes:
            myFitParent[genome_inc] = genome.fitness_vector
            genome_inc = genome_inc + 1
        ...
        for i in range(self.generations):
            ...
            self.train_simplified(new_population, writer, 0)
            genome_inc = 0


            for genome in new_population:
                myFitOffspring[genome_inc] = genome.fitness_vector
                genome_inc = genome_inc + 1
