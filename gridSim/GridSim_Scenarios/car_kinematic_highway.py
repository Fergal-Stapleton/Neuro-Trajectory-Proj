...
class HighwaySimulator(Simulator):
    ...
    def __init__(self, screen, screen_width, screen_height, car_x=3, car_y=27, sensor_size=100, rays_nr=8,
                 activations=False, highway_traffic=True, record_data=True, replay_data_path="replay_data/replay.txt", state_buf_path="state_buf/state_buf.txt", sensors=False,
