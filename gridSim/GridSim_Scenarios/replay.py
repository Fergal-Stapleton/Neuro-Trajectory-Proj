...
class Replay(CitySimulator):
    ...
    def replay(self, car_data_path, enable_trajectory=False):
        ...
        while not self.exit:
            ...
            replay_csv_path = "replay_data/replay.txt"
            save_simulator_frame_path="save_simulator_frame_path"
            save_sensor_frame_path="save_sensor_frame_path"
            save_debug_frame_path="save_debug_frame_path"
            self.record_from_replay(replay_csv_path, save_simulator_frame_path, save_sensor_frame_path,
                                                   save_debug_frame_path)
    ...
    def record_from_replay(self, replay_csv_path, save_simulator_frame_path=None, save_sensor_frame_path=None,
                           save_debug_frame_path=None, save_sensor_frame=True, save_simulator_frame=True,
                           save_debug_frame=True, draw_trajectory=True, traffic=True, display_obstacle_on_screen=True):
        """
        ...
        while not self.exit:
            ...
            activation_mask.fill((0, 0, 0))
            self.optimized_front_sensor(activation_mask, display_obstacle_on_sensor=display_obstacle_on_scree)
